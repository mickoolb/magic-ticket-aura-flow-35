        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-purple p-8 md:p-12">
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Vive una experiencia espiritual única en Chile
            </h2>
            <p className="text-white/90 mb-8 text-lg">
              No esperes más para transformar tu vida con este evento especial en Cascada de las Ánimas.
              Compra tu boleto ahora y asegura tu lugar para el 17 de Mayo, 2025.
            </p>
